...
function getNextDocumentNumber($pdo) {
    ...
    $stmt = $pdo->prepare("
        SELECT COUNT(*) 
        FROM edms_internal_in_documents 
        WHERE document_year = ?
    ");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        $stmt = $pdo->prepare("
            INSERT INTO edms_internal_in_documents (
        ...
        $_SESSION['message'] = "เพิ่มหนังสือรับเข้าภายในสำเร็จ";
...
<head>
    ...
    <title>สร้างหนังสือรับเข้าภายใน</title>
</head>
<body>
            ...
            <div class="col-md-9">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/edms/internal_in/">หนังสือรับเข้าภายใน</a></li>
                        <li class="breadcrumb-item active">สร้างหนังสือรับเข้าภายใน</li>
                    </ol>
                </nav>

                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">สร้างหนังสือรับเข้าภายใน</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" name="date_signed" class="form-control" required>
                                        <div class="invalid-feedback">
                                            กรุณาเลือกวันที่
                                        </div>
                                    </div>

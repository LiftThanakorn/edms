...
try {
    $stmt = $pdo->prepare("
        ...
        FROM edms_external_in_documents d
...
<head>
    ...
    <title>ทะเบียนหนังสือรับภายนอก</title>
            ...
            <div class="col-md-9">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">ทะเบียนหนังสือรับภายนอก</li>
                    </ol>
                </nav>

                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">ทะเบียนหนังสือรับภายนอก</h4>
                        <a href="create.php" class="btn btn-light">
                            <i class="bi bi-plus-lg"></i> เพิ่มทะเบียนหนังสือรับภายนอก
                        </a>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="documentsTable" class="table table-bordered table-striped table-hover">
                                <thead class="table-primary">
                                    <tr class="text-center">
                                        ...
                                        <th class="text-center" style="width: 10%">วันที่รับ</th>
                                        <th class="text-center" style="width: 15%">จาก</th>
                                        <th class="text-center" style="width: 15%">ถึง</th>
                                ...
                                <tbody>
                                    <?php foreach ($documents as $document): ?>
                                        <tr>
                                            <td class="text-center"><?php echo $document['document_number']; ?>/<?php echo $document['document_year']; ?></td>
                                            <td class="text-center"><?php echo $document['formatted_date_received']; ?></td>

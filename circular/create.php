...
// ฟังก์ชันสำหรับหาเลขหนังสือเวียนถัดไป
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        $current_year = date('Y');
        $next_number = getNextDocumentNumber($pdo); // ใช้ฟังก์ชันเพื่อหาเลขถัดไป
        ...
        $stmt = $pdo->prepare("
            INSERT INTO edms_circular_documents (
                document_number, document_year, title, sender, receiver,
                date_sent, attachment_path, category_id, created_by, note
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        ");
        ...
        $_SESSION['message'] = "เพิ่มข้อมูลหนังสือเวียนสำเร็จ";
            ...
            <div class="col-md-9">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">สร้างหนังสือเวียน</li>
                    </ol>
                </nav>

                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">สร้างหนังสือเวียน</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" value="ว <?php echo "$next_number/$current_year"; ?>" readonly>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="note" class="form-control" rows="3"
                                            placeholder="กรอณากรอกหมายเหตุ (ถ้ามี)"><?php echo isset($_POST['note']) ? htmlspecialchars($_POST['note']) : ''; ?></textarea>
                                    </div>
                                </div>

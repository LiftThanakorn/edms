...
function getNextDocumentNumber($pdo) {
    ...
    $stmt = $pdo->prepare("
        SELECT COUNT(*) 
        FROM edms_external_out_documents 
        WHERE document_year = ?
    ");
...
// ฟังก์ชันตรวจสอบเลขทะเบียนส่งซ้ำ
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        $stmt = $pdo->prepare("
            INSERT INTO edms_external_out_documents (
                document_number, document_year,
                title, sender, receiver, date_created,
        ...
        $_SESSION['message'] = "เพิ่มหนังสือส่งออกภายนอกสำเร็จ";
...
<head>
    ...
    <title>สร้างหนังสือส่งออกภายนอก</title>
</head>
<body>
            ...
            <div class="col-md-9">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">สร้างหนังสือส่งออกภายนอก</li>
                    </ol>
                </nav>

                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">สร้างหนังสือส่งออกภายนอก</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="invalid-feedback">กรุณาเลือกวันที่สร้างเอกสาร</div>
                                    </div>
                                    <div class="mb-3">
